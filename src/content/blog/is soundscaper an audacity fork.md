...
There is a *lot* of Audacity heritage inside Soundscaper, so calling Soundscaper an "Audacity fork" is justified to some degree as well. At the end of the day, words are just ape noises that we've assigned meaning to, and whether you're comfortable calling Soundscaper an Audacity fork is up to you. 